...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        #######################################################################
        note = CapitalT(self.h_rect.get_center(),
                        self.h_rect.get_width(),
                        self.v_rect.get_height(),
                        self.v_rect.get_lower_right_corner().x - self.v_rect.get_upper_left_corner().x)
        note.set_colors(self.h_rect.fill_color, self.v_rect.outline_color)
        return note
